<template>
	<body>
		<div class="app-container">
			<div class="app-main">
				<div class="chat-wrapper" id="bupt">
					<div class="message-wrapper">
						<img id = "img2"class="message-pp" src="../../../static/ask/2.jpg" alt="profile-pic">
						<img id = "img1"class="message-pp" style="display:none" src="../../../static/ask/1.jpg" alt="profile-pic">
						<div class="message-box-wrapper">
							<div class="message-box">
								尊敬的用户您好~
								<br>
								你可以问我xx的一级原因/根因/响应时间有限的情况下，模块x的服务组合方案等问题~
								<br>
								比如：网络速度低的一级原因是什么?
							</div>
						</div>
				...
				<div class="chat-input-wrapper">
					<button class="chat-attachment-btn">
						<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" stroke="currentColor"
							...
							class="feather feather-paperclip" viewBox="0 0 24 24">
							<defs></defs>
							<path
					...
					<div class="input-wrapper">
						<input type="text" class="chat-input" id="textinput" placeholder="请输入">
						<button class="emoji-btn">
							<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none"
								stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
								class="feather feather-smile" viewBox="0 0 24 24">
								<defs></defs>
					...
					<button class="chat-send-btn" @click="ask()">Send</button>
				</div>
			</div>
		</div>
	</body>
