...
function btn() {
  ...
  var img_src1 = document.getElementById("img1").src
  ...
  var data_tmp={"message":message};
  $.post('http://123.56.133.187:8080/buptsp', data_tmp, function(obj){
	  // $.post('http://localhost:8080/buptsp', data_tmp, function(obj){
		  // curl -d'data_tmp="速率低"'-X http://localhost:8080/buptsp
    ...
    img.setAttribute("class","message-pp");
    img.setAttribute("alt","profile-pic");
	var img_src2 = document.getElementById("img2").src
    // img.src="img/2.4815e459.jpg";
	img.src = img_src2
    ...
    text1.style.cssText ="white-space: pre-line";
    text1.innerHTML=obj["answer"];
